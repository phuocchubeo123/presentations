...
\begin{columns}[T]
  ...
  \begin{column}{0.58\textwidth}
    \centering
    \begin{tikzpicture}
      \node[anchor=center] (imgbase) at (0,0)
        {\includegraphics[width=0.98\linewidth]{contact-discovery.png}};
      \node[anchor=center, rotate=2] at ([xshift=0.8cm,yshift=1.4cm]imgbase)
        {\includegraphics[width=0.85\linewidth]{password-monitoring.png}};
      \node[anchor=center, rotate=-3] at ([xshift=-0.6cm,yshift=-0.3cm]imgbase)
...
\only<3>{
  Putting {\color{red} every points} and run plain PSI is too costly!
}
\vspace{15em}
...
\draw[->, thick, mygreen]
  ([yshift=-1cm] aliceimg.east) to[out=70,in=-150] ([xshift=2.2cm, yshift=2.2cm] aliceimg.east);
    ...
    % Instance 1 (top)
      ...
      \node at ([xshift=0.15cm,yshift=0.15cm] key0A.south) {$0$};

      \node (key1A) at ([xshift=2.8cm,yshift=2.9cm] aliceimg.east) 
        {\includegraphics[width=0.07\linewidth]{../Resources/redkey_mirror.png}};
      \node at ([xshift=0.15cm,yshift=0.15cm] key1A.south) {$1$};
    \draw[->, thick]
      ([yshift=2.2cm] aliceimg.east) to[out=10,in=170] ([xshift=4.3cm, yshift=2.2cm] aliceimg.east);
    \node (oracleA) 
        at ([yshift=2.2cm, xshift=4.9cm] aliceimg.east)
  ...
  \visible<4>{
    % Instance 2 (middle)
      ...
      \node at ([xshift=0.15cm,yshift=0.15cm] key0B.south) {$0$};

      \node (key1B) at ([xshift=2.8cm,yshift=1.5cm] aliceimg.east) 
        {\includegraphics[width=0.07\linewidth]{../Resources/bluekey_mirror.png}};
      \node at ([xshift=0.15cm,yshift=0.15cm] key1B.south) {$1$};
    \draw[->, thick]
...
\begin{tikzpicture}[overlay, remember picture]
  ...
  % --- Bob's \kappa keys above him ---
    ...
    \node at ([xshift=-0.8cm, yshift=0.5cm] bobimg.north)
      {\includegraphics[width=0.07\linewidth]{../Resources/redkey_mirror.png}};
    \node at ([xshift=-0.8cm, yshift=0.3cm] bobimg.north) {{\scriptsize \textcolor{red}{$b_1$}}};

    \node at ([xshift=0cm, yshift=0.5cm] bobimg.north)
      {\includegraphics[width=0.07\linewidth]{../Resources/bluekey_mirror.png}};
    \node at ([xshift=0cm, yshift=0.3cm] bobimg.north) {{\scriptsize \textcolor{blue}{$b_2$}}};

  \node at ([xshift=0.45cm, yshift=0.5cm] bobimg.north) {$\cdots$};

  \node at ([xshift=1.0cm, yshift=0.5cm] bobimg.north)
    {\includegraphics[width=0.07\linewidth]{../Resources/blackkey_mirror.png}};
  \node at ([xshift=1.0cm, yshift=0.3cm] bobimg.north) {{\scriptsize \textcolor{black}{$b_3$}}};
  ...
  % --- One-sided vertical interval (anchored near top-left for visibility) ---
    ...
    \visible<2,3,4>{
    \node[anchor=west] (hashTop) at ([xshift=3.5cm,yshift=-1.9cm] current page.north west) {$H({\tt FSS.Eval}_0(0), \ldots, {\tt FSS.Eval}_0(0))$};
    \draw[->, thick, mygreen]
      ([xshift=1.7cm,yshift=-1.9cm] current page.north west) to ([xshift=3.6cm,yshift=-1.9cm] current page.north west);
    }
    \visible<3,4>{
    \node[anchor=west] (hashTop2) at ([xshift=3.5cm,yshift=-2.4cm] current page.north west) {$H({\tt FSS.Eval}_0(1), \ldots, {\tt FSS.Eval}_0(1))$};
...
For points $x > \alpha$, Ailce wants to learn {\color{orange} aggregation $\oplus \beta$}.
}
\vspace{15em}
\begin{tikzpicture}[overlay, remember picture]
  % --- Alice image ---
...
\begin{frame}
\frametitle{Related Works: Fuzzy Private Set Intersection}
...
\begin{itemize}
    ...
    \item Symmetric Key Techniques: \cite{zhang2025fast, van2025fuzzy}.
\end{itemize}
